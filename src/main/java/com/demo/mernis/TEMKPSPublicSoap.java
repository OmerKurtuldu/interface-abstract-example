...
public class TEMKPSPublicSoap
{
    ...
    public TEMKPSPublicSoap(){}

    public TEMKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public TEMKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TEMExtendedSoapSerializationEnvelope envelope= new TEMExtendedSoapSerializationEnvelope(TEMExtendedSoapSerializationEnvelope.VER11);
