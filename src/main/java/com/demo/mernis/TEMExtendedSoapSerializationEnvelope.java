...
class TEMSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class TEMExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(TEMDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new TEMStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static TEMDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static TEMDateTimeConverter dateTimeConverter = new TEMStandardDateTimeConverter();

    public TEMExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TEMExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TEMMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=TEMHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,TEMExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=TEMHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
